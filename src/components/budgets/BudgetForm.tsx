...
const BudgetForm: React.FC<BudgetFormProps> = ({ onFormSubmit }) => {
  const { addBudget, categories, budgets } = useAppContext();
  ...
  const onSubmit = (data: BudgetFormValues) => {
    ...
    toast({ title: "Budget Created", description: `Budget for ${categories.find(c=>c.id === data.categoryId)?.name} set to $${data.amount}.`});
    reset();
