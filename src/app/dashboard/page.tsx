...
const StatCard: React.FC<Insight & { cta?: { href: string; label: string } }> = ({ title, value, change, icon: Icon, color, cta }) => {
    ...
    <AppShell>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {insights.map(insight => <StatCard key={insight.title} {...insight} />)}
        </div>
