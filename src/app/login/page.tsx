...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // If user is null, signInWithGoogle might have handled the error or user cancelled.
    } catch (error: any) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center text-foreground">Login to BudgetWise</CardTitle>
